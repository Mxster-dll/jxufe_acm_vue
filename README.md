...
| 同档递减 | 同一层级同一奖牌第 k 次 × 0.7ᵏ⁻¹，下限 0.2 → **同一档位最多贡献 3.33 倍单次分**（防「多打低级别比赛刷数量」） | `REPEAT_DECAY` |
...
- 手写战绩按赛事关键词定层级（睿抗 0.4、传智杯 0.35、数学建模 0.45，含「区域赛 / 邀请赛 / 省赛」字样的按 xCPC 对应层级）；
  带名次的加成：冠军 ×1.6、亚军 ×1.3，首刀单独 +0.5；只写赛事名没写档位的按「参赛经历」0.6 计。
