      ...
      <template v-else>
        ...
        <template v-else>
          ...
          <section class="award-section">
            <h2 class="section-label"><i class="fa-solid fa-trophy"></i> 国赛获奖情况</h2>
          ...
          <!-- 省赛获奖情况 -->
          <section class="award-section">
            <h2 class="section-label"><i class="fa-solid fa-medal"></i> 省赛获奖情况</h2>
